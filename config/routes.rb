Rails.application.routes.draw do
  ...
  delete "onboarding/bulk_delete_keys" => "onboarding#bulk_delete_keys", as: :bulk_delete_keys_onboarding
  ...
  namespace :admin do
    ...
    # Salt Editor - State file management
    resources :salt_states do
      member do
        post :deploy
        post :undeploy
        post :clone
  ...
  namespace :settings do
    ...
    resources :netbird_setup_keys do
      member do
        post :toggle
        post :deploy
      end
  ...
  resources :groups do
    member do
      post :manage_servers  # Bulk add/remove servers from group
    end
  end
